...
public class Board {
	...
	//if king is white set white king to true else set black king to true
	...
	//if king moved is white set white king to true else set black king to true
	...
	//set rook based on piece color and piece type (king or queen)
	...
	//returns boolean based on piece color and type
