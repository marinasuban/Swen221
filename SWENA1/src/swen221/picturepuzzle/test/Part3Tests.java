...
public class Part3Tests {
	...
	//1 rotation = 5 rotations on the same tile
	@Test public void test_31() {
		...
		// Create board
		Board board1 = new Board(image,6,3);
		Board board2 = new Board(image,6,3);
		// Apply operation sequence
		board1.apply(new Rotation(new Location(1,0),1));
		board2.apply(new Rotation(new Location(1,0),5));

		// Check output
		assertEquals(board1.toString(),board2.toString());
	}
	
	//4 rotations on 2 different tiles should revert to original board
		@Test public void test_32() {
			...
			// Create board
			Board board = new Board(image,6,3); //control
			Board board1 = new Board(image,6,3);
			Board board2 = new Board(image,6,3);
			// Apply operation sequence
			board1.apply(new Rotation(new Location(2,2),4));
			board2.apply(new Rotation(new Location(1,1),4));

			// Check output
			assertEquals(board.toString(),board1.toString());
			assertEquals(board1.toString(),board2.toString());
		}
		
	//invalid -ve rotation, should do nothing
	...
	//invalid location, should do nothing
	...
	}//null location with valid rotation steps, should do nothing
	@Test public void test_35() {
		...
		Board board = new Board(image,6,3); //control
		// Apply operation sequence
		board.apply(new Rotation(null, 3));
